...
#     """
#     A class to evaluate and visualize metrics from a single model training run.
#     Generates plots showing training curves and confusion matrices.
#     """
    
#     def __init__(self, evaluation_dir: str):
#         """
#         Initialize the evaluator with the directory containing model results.
        
#         Args:
#             evaluation_dir (str): Path to directory containing model evaluation results
#         """
...
#         """
#         Perform evaluation of the model and create visualizations.
        
#         Args:
#             test_config: Optional configuration for test dataset creation
#                        Default values: batch_size=-1, random_state=69
#         """
...
#         """Validate the evaluation directory exists and contains required files."""
...
#         """Load metrics from the Full metrics file."""
#         metrics_pattern = self.evaluation_dir / '*_Full_metrics.json'
...
#         """
#         Load a model from a checkpoint file, handling both full models and state dictionaries.
...
#         Raises:
#             ValueError: If the model format is unrecognized
#         """
#         try:
...
#         """
#         Load the training configuration from the evaluation directory.
...
#         Returns:
#             torch.nn.Module: New model instance
#         """
...
#         """
#         Compute confusion matrix for a specific model checkpoint.
        
#         Args:
#             model_type: Type of model to evaluate ('bestF1' or 'bestLoss')
#             test_config: Configuration for test dataset creation
        
#         Returns:
#             numpy.ndarray: Computed confusion matrix
#         """
